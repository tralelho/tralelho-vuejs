...
<template>
  <div class="section">
    <h1>Translation Page locale: {{ locale }}</h1>

    <div class="container mb-6" v-for="section of pageConfig" :key="section.title">
      <h2 class="title is-2 has-text-left" v-t="{ path: section.title }"></h2>
